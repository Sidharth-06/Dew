...
import 'package:Dew/widgets/confirmation_dialog.dart';
import 'package:Dew/widgets/custom_bar.dart';
import 'package:Dew/widgets/custom_search_bar.dart';
import 'package:Dew/widgets/song_bar.dart';
          ...
          children: <Widget>[
            CustomSearchBar(
              ...
              onChanged: (value) async {
                if (value.isNotEmpty) {
                  _suggestionsList = await getSearchSuggestions(value, playlistsNum: 10);
                } else {
                  _suggestionsList = [];
                }
                setState(() {});
